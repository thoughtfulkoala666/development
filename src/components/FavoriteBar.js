        ...
        {console.log("active filters: ", props.activeFilters)}
          <input
            ...
            onChange={
              (e) => {
                if (e.target.checked) {
                  console.log("add favorite only filter")
                  props.setShowFavorites(true)
                } else {
                  console.log("remove favorite only filter")
